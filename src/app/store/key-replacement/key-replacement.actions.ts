...
export const selectDevice = createAction(
  '[Key Replacement] select device',
  props<{ deviceId: string }>(),
);
export const setNewDeviceName = createAction(
  '[Key Replacement] set new device name',
  props<{ deviceName: string }>(),
);

export const invalidateKey = createAction(
  '[Key Replacement] invalidate key',
  props<{ deviceId: string }>(),
);
...
export const programDevice = createAction(
  '[Key Replacement] program device',
  props<{ deviceId: string }>(),
);
